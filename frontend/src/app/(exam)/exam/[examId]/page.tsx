...
import { Clock, Send, ChevronLeft, ChevronRight, Loader2, LogOut } from 'lucide-react';
...
export default function ExamPage() {
  ...
  const getCode = (problemId: string, lang: string) => {
    return codes[problemId]?.[lang] || '';
  };
